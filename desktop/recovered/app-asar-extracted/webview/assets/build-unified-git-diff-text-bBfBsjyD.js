import{s as e}from"./chunk-Bj-mKKzh.js";import{d as t,p as n,t as r}from"./path-browserify-Chh2Zpai.js";import{l as i}from"./quote-cmd-DffyUwzZ.js";var a=n({"codex/browserUse":t(!0)});function o({resultMeta:e,serverName:t}){return t===`node_repl`&&a.safeParse(e).success?`browser-use`:null}function s(e){return e.source===`browser-use`}var c=e(r(),1);function l(e,t){if(t.type===`update`){let n=e,r=t.move_path??e,i=t.unified_diff.trimStart(),a=/\n?---\s/.test(i),o=/^diff --git /m.test(i),s=a?i:`--- a/${n}\n+++ b/${r}\n${i}`;return`${o?``:`diff --git a/${n} b/${r}\n`}${s}`}if(t.type===`add`){let n=t.content.replace(/\r\n/g,`
`).split(`
...
//# sourceMappingURL=build-unified-git-diff-text-bBfBsjyD.js.map